...
const baseClass =
  'back-btn inline-flex items-center gap-1.5 rounded-[10px] border border-[#E5E7EB] bg-white py-2 px-3.5 text-[14px] font-semibold text-[#4B5563] transition-colors hover:bg-[#F9FAFB] mb-5';
