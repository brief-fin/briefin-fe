        ...
        <div className="footer-links mb-4 flex flex-wrap items-center gap-5">
          {FOOTER_LINKS.map((item) => (
            <Link
              ...
              className={
                item.bold
                  ? 'footer-link text-[13px] font-bold text-[#4B5563] transition-colors hover:text-[#1E3A8A]'
                  : 'footer-link text-[13px] font-semibold text-[#9CA3AF] transition-colors hover:text-[#1E3A8A]'
              }>
              {item.label}
            </Link>
          ))}
